...
async function run() {
    ...
    const keyCandidates = [
        ...
        { label: "Office Code", val: OFFICECODE },
        { label: "Service ID", val: SERVICEID }
    ];

    console.log(`Starting live execution for 4-param permutations...`);
    ...
    for (const p of permutations) {
        for (const keyCand of keyCandidates) {
            ...
            for (const f of formulas) {
                ...
                if (index % 50 === 0) {
                    console.log(`Tested ${index} live permutations...`);
                }
    ...
    console.log("Completed. No formula succeeded.");
}
