...
export default function ContactPage() {
  ...
  return (
    <>
      <TopHeader src={header} alt="Contact Us" title="Contact Us" subtitle="Need Help? We are Just a Message Away!" />
        ...
        <div className="bg-[#faf7fc] py-20">
          ...
          <div className="flex justify-center mb-14 px-4">
            <div className="relative flex bg-white shadow-lg border border-[#f1e4ff] rounded-full p-1.5 w-[290px] overflow-hidden">
              ...
              {/* Active Background */}
              <div
                className={`absolute top-1.5 bottom-1.5 w-[48%] rounded-full bg-primary from-fuchsia-600 to-violet-600 transition-all duration-500 ${active === "jodhpur"
                  ? "left-[6px]"
                  : "left-[50%]"
                  }`}
              />
              ...
              <button
                ...
                className={`relative z-10 flex-1 py-3 text-sm font-semibold rounded-full transition-all duration-300 cursor-pointer ${active === "jodhpur"
                  ? "text-white"
              ...
              <button
                ...
                className={`relative z-10 flex-1 py-3 text-sm font-semibold rounded-full transition-all duration-300 cursor-pointer ${active === "jaipur"
                  ? "text-white"
                  : "text-gray-600 hover:text-black"
                  }`}
              >
