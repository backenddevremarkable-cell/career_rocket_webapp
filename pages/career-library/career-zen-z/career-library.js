              ...
              {popularity?.map(
                (item, index) => (
                  <button
                    ...
                    key={index}
                    className={`rounded-full px-5 py-[10px] text-sm font-medium transition-all duration-300 cursor-pointer ${actviePopularity == item.id
                ...
                data?.records.map((item, index) => {
                  ...
                  >
                    ...
                    >
                      ...
                      {/* ICON */}
                      <div className="mt-6 mx-auto flex h-[68px] w-[68px] items-center justify-center rounded-2xl bg-gradient-to-br from-[#faf5ff] to-[#fdf2f8] text-[28px] text-violet-500 shadow-inner transition-all duration-500 group-hover:scale-110">
                        <ImageMedia
                          img={item.icon}
                          alt={item.name_en}
