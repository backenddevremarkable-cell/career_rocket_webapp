 ...
 const handleClick = (e) => {
  ...
  return (
    ...
    >
        ...
        {/* Gradient Glow */}
        <div className="absolute inset-0 bg-gradient-to-br from-yellow-50 via-white to-purple-100 opacity-0 group-hover:opacity-100 transition duration-500" />

        {/* Top Badge */}
        <div className="absolute top-4 right-4 z-20">
            <span className="px-3 py-1 text-xs font-semibold rounded-full bg-yellow-100 text-yellow-700 shadow-sm">
