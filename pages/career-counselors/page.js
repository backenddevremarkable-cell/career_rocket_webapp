...
import header from "../../assets/images/header-pic/counselor.jpg";
...
export default function Counselors() {
  ...
  return (<>
    <TopHeader src={header} alt="Career Counselors" title="Career Counselors" subtitle="Connect with experienced career counselors to get expert guidance, personalized career advice, and support" />
