...
export default function myTest() {
 ...
 <div
  key={course?.id || index}
  className="group relative overflow-hidden rounded-[12px] bg-white p-5 transition-all duration-300 hover:-translate-y-1"
>
  {/* TOP GLOW */}
  ...
  <div className="relative flex flex-col gap-5 md:flex-row">
    ...
    {/* COURSE IMAGE */}
    <div className="relative h-[100px] w-[100px] shrink-0 overflow-hidden rounded-[20px] bg-[#faf7fc] shadow-sm">
